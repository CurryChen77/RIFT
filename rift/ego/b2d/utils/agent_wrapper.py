...
from rift.ego.b2d.utils.sensor_interface import CallBack, OpenDriveMapReader, SpeedometerReader, SensorConfigurationInvalid
from rift.ego.b2d.utils.autonomous_agent import AutonomousAgent, Track
...
class AgentWrapper(object):
    ...
    def setup_sensors(self, vehicle):
        ...
        # Important! need to update the game time and carla data provider
