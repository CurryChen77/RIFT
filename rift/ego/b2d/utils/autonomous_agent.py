...
class AutonomousAgent(object):
    ...
    def __init__(self, save_result=None, carla_host=None, carla_port=None, debug=False):
    ...
    def set_global_plan(self, global_plan_gps, global_plan_world_coord, hero_actor):
        """
